...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../view/photos.css">
	</head>
...
?>
		...
		<div id="right-nav">
			<h1>Your Photo Diary</h1>
	<div>
			<form method="post" action="../model/add_photo.php" enctype="multipart/form-data">
...
?>
		...
		<div class="photo-select">
			<center>
				...
				<hr>
				<a href="../model/delete_photos.php<?php echo '?id='.$id; ?>" class="btn-delete-photos">Delete</a>
			</center>
		</div>
