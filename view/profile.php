...
<?php include ('../model/session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><b><a href="timeline.php" title="Biobook">My Portfolio</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
	...
	<div id="container">
		...
		<div id="left-nav">
				...
				<div class="clip1">
				<a href="../model/updatephoto.php" title="Change Profile Picture"><img src="<?php echo '../'.$row['profile_picture'] ?>"><button>Update Picture</button></a>
