...
<html>
	...
	<head>
		<title>Welcome  To My Portfolio - Sin up, Log in, Chat </title>
...
<body>
	...
	<div id="container">
		...
		<form method="post" action="../model/signup_form.php" enctype="multipart/form-data">
		...
		<br />
			...
			<strong>Yes, I have read and I accept the <a href="#">My Portfolio Terms of Use</a> and the <a href="#">Sociable Privacy Statement</a></strong>
