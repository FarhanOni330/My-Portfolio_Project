...
<?php
include("../controller/timeline_controller.php");
...
<html>
	...
	<head>
		<title>Welcome  To My Portfolio - Sign up, Log in, Post </title>
		<link rel="stylesheet" type="text/css" href="../view/timeline.css">
	</head>
...
<?php include ('../model/session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="timeline.php" title="Biobook"><b>My Portfolio</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
	...
	<div id="container">
		...
		<div id="clip2">
				<a href="../model/updatecover.php" title="Change Cover Photo"><img src="<?php echo '../'.$row['cover_picture'] ?>"></a>
		...
		<div id="left-nav">
				...
				<a href="../model/updatephoto.php" title="Change Profile Picture"><img src="<?php echo '../'.$row['profile_picture'] ?>"></a>
				</div>
...
?>
		...
		<br />
			...
			<a href="../model/delete_post.php<?php echo '?id='.$post_id; ?>" title="Delete your post"><button class="btn-delete">X</button></a>
			</div>
